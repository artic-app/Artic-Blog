...
public class PreferenceBlogadapter extends  RecyclerView.Adapter<PreferenceBlogadapter.MyViewHolder> {
    ...
    public PreferenceBlogadapter(PreferenceFragment mContext, List<BlogInstance> blogList) {
        this.blogList = blogList;
    }

    @NonNull
    @Override
    public PreferenceBlogadapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.individual_blog, parent, false);
        return new MyViewHolder(itemView);
    }

    public void onBindViewHolder(@NonNull PreferenceBlogadapter.MyViewHolder holder, int position) {
